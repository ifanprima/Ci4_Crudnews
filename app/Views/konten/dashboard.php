...
================================= -->
    <section class="dashboard-wrap d-flex">
        <ul class="navbar-nav dashboard-sidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url(); ?>/dboard">
                    <i class="la la-dashboard font-size-18 mr-1"></i>
                    <span>Dashboard</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url(); ?>/d">
                    <i class="la la-dashboard font-size-18 mr-1"></i>
                    <span>News</span>
                </a>
            </li>
        ...
        <div class="dashboard-body d-flex flex-column">
            <div class="dashboard-inner-body flex-grow-1">
                ...
                <div class="card container" style="width: 1200px; height: 450px; overflow:scroll;">
                                ...
                                <table class="table table-hover container">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($berita as $b) : ?>
                                            <tr>
                                                <th scope="row"><?= $i++; ?></th>
                                                <td><img src="<?= base_url(); ?>/images/<?= $b['sampul']; ?>" alt="" style="width: 55px; height: 35px;"></td>
                                                <td><?= $b['judul']; ?></td>
                                                <td>
                                                    <a href="<?= base_url(); ?>/berita/<?= $b['slug']; ?>" class="btn btn-secondary" id="tom">Detail</a>
                                                    <a href="<?= base_url(); ?>/edit/<?= $b['slug']; ?>" class="btn btn-warning" id="tom">Edit</a>
